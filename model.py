...
class SSLModel(nn.Module):
    def __init__(self,device):
        ...
        # cp_path = '/public/home/qinxy/zhangzs/SSL_Anti-spoofing-main/SSL_Anti-spoofing-main/ckpt/xlsr2_300m.pt'#model commonly used before
        cp_path = '/public/home/qinxy/zhangzs/SLSforASVspoof-2021-DF-main/SLSforASVspoof-2021-DF-main/models/xlsr2_300m.pt'#model new now
    ...
    def extract_feat(self, input_data):
        ...
        if True:
            ...
            emb = outs['x']; layerresult = outs['layer_results']
